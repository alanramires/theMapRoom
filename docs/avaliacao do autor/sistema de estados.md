...
- Estado micro da unidade / entrada (`TurnStateManager`):
  - controla ciclo de interacao via `CursorState` (`Neutral`, `UnitSelected`, `MoveuAndando`, `MoveuParado`, `Capturando`, `Mirando`, `Pousando`, `Embarcando`, `Desembarcando`, `Fundindo`, `ShoppingAndServices`, `Suprindo`, `InspectingUnit`, `InspectingBuilding`, `InspectingHotZone`, `CommandService`, `RemovingUnit`)
...
- `TurnStateManager` foi particionado em arquivos parciais por subdominio (`Automation`, `ConstructionShopping`, `Disembark`, `Movement`, `Sensors`, `Combat`, `Supply`, `Transfer`, `HelperPanel`, `ScannerPrompt`, `StateMachine`, `ReplayRecording`), mantendo o mesmo nucleo de estado.
